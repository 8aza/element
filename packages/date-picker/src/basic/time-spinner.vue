  ...
  <div class="baza-xls-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <baza-xls-scrollbar
        ...
        view-class="baza-xls-time-spinner__list"
        noresize
        tag="ul"
        ref="hours">
        <li
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="baza-xls-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="baza-xls-time-spinner__arrow baza-xls-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="baza-xls-time-spinner__arrow baza-xls-icon-arrow-down"></i>
        <ul class="baza-xls-time-spinner__list" ref="hours">
          <li
            class="baza-xls-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="baza-xls-time-spinner__arrow baza-xls-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="baza-xls-time-spinner__arrow baza-xls-icon-arrow-down"></i>
        <ul class="baza-xls-time-spinner__list" ref="minutes">
          <li
            class="baza-xls-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="baza-xls-time-spinner__arrow baza-xls-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="baza-xls-time-spinner__arrow baza-xls-icon-arrow-down"></i>
        <ul class="baza-xls-time-spinner__list" ref="seconds">
          <li
